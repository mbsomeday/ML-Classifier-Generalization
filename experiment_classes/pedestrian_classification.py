...
class Ped_Classifier():
    def __init__(self, opts):
        ...
        # self.ped_model = timm.create_model("deit_small_patch16_224", pretrained=False, num_classes=2).to(DEVICE)
    ...
    def training_setup(self):
        ...
        self.callback_save_dir = self.opts.ped_model_obj.rsplit('.')[-1].replace('_', '') + '_' + ''.join(self.opts.ds_name_list) + '_' + self.opts.exp_name + '_' + str(self.opts.rand_seed)
