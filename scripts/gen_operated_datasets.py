...
def get_opts():
    ...
    #
    # # 生成图片的保存dir
    # parser.add_argument('--genImg_save_dir', type=str, default=r'D:\my_phd\dataset\Stage6\stage6_bdd100k\All_Processor\M3CAM\OnlyPerturb', help='base dir path, no need to add the txt name')
    #
    # # 生成perturbation+aug图片
